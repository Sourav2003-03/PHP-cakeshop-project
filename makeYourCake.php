...
<html lang="en-MU">
    <head>
        <meta charset="utf-8">
        <title>Juneja | MAKE YOUR CAKE</title>
    ...
    <body>
        ...
        <footer class="footer-group">
            ...
            <div class="footer">
                ...
                <div class="logo">
                    <span class="logo-name">Juneja</span>
                </div>
                ...
                <div class="contact-links">
                    <span class="phone"><i class="fas fa-phone-square-alt"></i> +91 7303924560 </span>
                    <span class="address">Juneja Fresh Bakery At South Delhi</span>
                </div>
                ...
                <div class="copyright">
                    <span class="copyright-text">&#169; 2023 design by Sourav Mukherjee</span>
                </div>
